...
func (c *external) Observe(ctx context.Context, cr *v1alpha1.Environment) (managed.ExternalObservation, error) {
...
func (c *external) Create(ctx context.Context, cr *v1alpha1.Environment) (managed.ExternalCreation, error) {
...
func (c *external) Update(ctx context.Context, cr *v1alpha1.Environment) (managed.ExternalUpdate, error) {
...
func (c *external) Delete(ctx context.Context, cr *v1alpha1.Environment) (managed.ExternalDelete, error) {
