...
func SetupGated(mgr ctrl.Manager, o controller.Options) error {
	o.Gate.Register(func() {
		if err := Setup(mgr, o); err != nil {
			panic(errors.Wrap(err, "cannot setup SDKConnection controller"))
		}
	}, v1alpha1.SDKConnectionGroupVersionKind)
	return nil
}
...
func Setup(mgr ctrl.Manager, o controller.Options) error {
	...
	if o.MetricOptions != nil && o.MetricOptions.MRStateMetrics != nil {
		stateMetricsRecorder := statemetrics.NewMRStateRecorder(
			mgr.GetClient(), o.Logger, o.MetricOptions.MRStateMetrics, &v1alpha1.SDKConnectionList{}, o.MetricOptions.PollStateMetricInterval,
		)
		if err := mgr.Add(stateMetricsRecorder); err != nil {
			return errors.Wrap(err, "cannot register MR state metrics recorder for kind v1alpha1.SDKConnectionList")
		}
	}

	r := managed.NewReconciler(mgr, resource.ManagedKind(v1alpha1.SDKConnectionGroupVersionKind), opts...)

	return ctrl.NewControllerManagedBy(mgr).
		Named(name).
		WithOptions(o.ForControllerRuntime()).
		WithEventFilter(resource.DesiredStateChanged()).
		For(&v1alpha1.SDKConnection{}).
...
func (c *external) Observe(ctx context.Context, cr *v1alpha1.SDKConnection) (managed.ExternalObservation, error) {
...
func (c *external) Create(ctx context.Context, cr *v1alpha1.SDKConnection) (managed.ExternalCreation, error) {
...
func (c *external) Update(ctx context.Context, cr *v1alpha1.SDKConnection) (managed.ExternalUpdate, error) {
...
func (c *external) Delete(ctx context.Context, cr *v1alpha1.SDKConnection) (managed.ExternalDelete, error) {
