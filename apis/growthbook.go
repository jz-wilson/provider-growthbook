...
// Package apis contains Kubernetes API for the GrowthBook provider.
package apis
...
func init() {
	...
	AddToSchemes = append(AddToSchemes,
		growthbookv1alpha1.SchemeBuilder.AddToScheme,
		corev1alpha1.SchemeBuilder.AddToScheme,
		featurev1alpha1.SchemeBuilder.AddToScheme,
		sdkv1alpha1.SchemeBuilder.AddToScheme,
	)
}
